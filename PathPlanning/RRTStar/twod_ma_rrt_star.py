...
def main():
    ...
    plt.plot([x for [x, y, t] in rrt_star1.d_path], [y for [x, y, t] in rrt_star1.d_path], 'b', label="Robot 0")
    ...
    plt.plot([x for [x, y, t] in rrt_star2.d_path], [y for [x, y, t] in rrt_star2.d_path], 'g', label="Robot 1")
    plt.plot(rrt_star2.start.x, rrt_star2.start.y, "xb")  #need z
    plt.plot(rrt_star2.end.x, rrt_star2.end.y, "xg")  
    plt.plot([x for [x, y, t] in rrt_star3.path[1:-1]], [y for [x, y, t] in rrt_star3.path[1:-1]], 'r*') #TODO: change when z is added
    plt.plot([x for [x, y, t] in rrt_star3.d_path], [y for [x, y, t] in rrt_star3.d_path], 'y', label="Robot 2")
    plt.plot(rrt_star3.start.x, rrt_star3.start.y, "xb")  #need z
    plt.plot(rrt_star3.end.x, rrt_star3.end.y, "xg")  
    plt.grid(True)
