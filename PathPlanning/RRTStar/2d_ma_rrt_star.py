...
def main():
    ...
    if show_animation:
        ...
        plt.plot([x for [x, y, t] in MARRT.RRT_list[0].path], [y for [x, y, t] in MARRT.RRT_list[0].path], 'r*') #TODO: change when z is added
        plt.plot([x for [x, y, t] in MARRT.RRT_list[0].d_path], [y for [x, y, t] in MARRT.RRT_list[0].d_path], 'b')
